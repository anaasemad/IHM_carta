...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        compas = new QPushButton(widget_2);
        compas->setObjectName("compas");
        compas->setEnabled(true);
        compas->setGeometry(QRect(39, 0, 31, 24));
        sizePolicy2.setHeightForWidth(compas->sizePolicy().hasHeightForWidth());
        compas->setSizePolicy(sizePolicy2);
        compas->setMaximumSize(QSize(167, 167));
        compas->setIconSize(QSize(10, 16));
        ...
        regla = new QPushButton(widget_2);
        regla->setObjectName("regla");
        regla->setGeometry(QRect(70, 0, 40, 24));
        sizePolicy2.setHeightForWidth(regla->sizePolicy().hasHeightForWidth());
        regla->setSizePolicy(sizePolicy2);
        regla->setMaximumSize(QSize(167, 167));
        arco = new QPushButton(widget_2);
        arco->setObjectName("arco");
        arco->setGeometry(QRect(110, 0, 40, 24));
        sizePolicy2.setHeightForWidth(arco->sizePolicy().hasHeightForWidth());
        arco->setSizePolicy(sizePolicy2);
        arco->setMaximumSize(QSize(167, 167));
        QFont font;
        font.setKerning(true);
        arco->setFont(font);
        arco->setIconSize(QSize(8, 16));
        ...
        carta_mapa = new QGraphicsView(verticalWidget);
        carta_mapa->setObjectName("carta_mapa");

        verticalLayout_3->addWidget(carta_mapa);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        compas->setText(QCoreApplication::translate("MainWindow", "compas", nullptr));
        limpiar->setText(QCoreApplication::translate("MainWindow", "limpiar", nullptr));
        regla->setText(QCoreApplication::translate("MainWindow", "regla", nullptr));
        arco->setText(QCoreApplication::translate("MainWindow", "arco", nullptr));
    } // retranslateUi
